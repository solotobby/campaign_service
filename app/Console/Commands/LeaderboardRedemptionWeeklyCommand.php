...
class LeaderboardRedemptionWeeklyCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'leaderboard:weeklyredemption';
     ...
     * @var string
     */
    protected $description = 'Handle weekly rewards for leaderboards';
        ...
        foreach ($campaigns as $campaign) {
            ...
            foreach ($leaderboard as $key => $player) {
                if (array_key_exists($player->audience_id, $audiences)) {
                    ...
                    // get reward
                    $reward = $campaign->leaderboardRewards->where('frequency', 'WEEKLY')
